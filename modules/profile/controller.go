...
func routes(rg *gin.RouterGroup) {
	profileProtectedRoute := rg.Group("/profile")
	profileProtectedRoute.Use(core.JwtAuthMiddleware())
	profileProtectedRoute.GET("", getProfileDetail)
	profileProtectedRoute.PUT("/:id", updateProfile)
	profileProtectedRoute.DELETE("/:id", deleteProfile)
}
